...
Started, Settings, FAQ, Release Notes, About). The site will support auto dark/light
...
19. As a user, I want a Release Notes page, so that I can see what's new or fixed
    in each plugin version.
