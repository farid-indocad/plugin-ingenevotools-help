...
- **Ribbon:** Ingenevo Tools Tab â†’ Panel Renumber Layout â†’ Button Renumber Layout
...
2. Ikuti prompt di command line untuk mengatur format penomoran:
   - **Prefix** â€” teks sebelum nomor (opsional)
   - **Suffix** â€” teks setelah nomor (opsional)
   - **Start Number** â€” nomor awal
   - **Digits** â€” jumlah digit (misalnya 2 â†’ 01, 02, 03...)
...
| **Digits** | Jumlah digit minimum | `2` â†’ 01, 02, ... |
